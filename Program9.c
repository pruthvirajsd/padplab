//Write a MPI- C which estimates the time it takes to send a vector of N double precision values through each process in a ring.
...
void ring_io (int p, int id){
  ...
  int n_test_num = 5, source,test, test_num = 10;
  MPI_Status status;
